# Replace this with your image name, i.e. ghcr.io/<your-username>/demo-repo-rust:latest
IMAGE_NAME?=ghcr.io/stacklok/demo-repo-rust:latest
...
build-binary:
	...
	# TODO: Implement this when we need it for the rust example
